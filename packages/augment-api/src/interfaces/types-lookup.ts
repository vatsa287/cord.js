...
declare module '@polkadot/types/lookup' {
  ...
  /** @name CordWeaveRuntimeSessionKeys (146) */
  ...
  /** @name CordWeaveRuntimeMaxNewKeyAgreementKeys (224) */
  ...
  /** @name CordWeaveRuntimeOriginCaller (268) */
  ...
  /** @name PalletDidOriginDidRawOrigin (272) */
  ...
  /** @name SpConsensusBabeDigestsPreDigest (281) */
  ...
  /** @name SpConsensusBabeDigestsPrimaryPreDigest (282) */
  ...
  /** @name SpCoreSr25519VrfVrfSignature (283) */
  interface SpCoreSr25519VrfVrfSignature extends Struct {
    readonly preOutput: U8aFixed;
    readonly proof: U8aFixed;
  }

  /** @name SpConsensusBabeDigestsSecondaryPlainPreDigest (284) */
  interface SpConsensusBabeDigestsSecondaryPlainPreDigest extends Struct {
    readonly authorityIndex: u32;
    readonly slot: u64;
  }

  /** @name SpConsensusBabeDigestsSecondaryVRFPreDigest (285) */
  ...
  /** @name SpConsensusBabeBabeEpochConfiguration (286) */
  interface SpConsensusBabeBabeEpochConfiguration extends Struct {
    readonly c: ITuple<[u64, u64]>;
    readonly allowedSlots: SpConsensusBabeAllowedSlots;
  }

  /** @name PalletBabeError (290) */
  ...
  /** @name AuthorityMembershipError (291) */
  ...
  /** @name FrameSupportTokensMiscIdAmountRuntimeHoldReason (302) */
  interface FrameSupportTokensMiscIdAmountRuntimeHoldReason extends Struct {
    readonly id: CordWeaveRuntimeRuntimeHoldReason;
    readonly amount: u128;
  }

  /** @name CordWeaveRuntimeRuntimeHoldReason (303) */
  ...
  /** @name PalletPreimageHoldReason (304) */
  interface PalletPreimageHoldReason extends Enum {
    readonly isPreimage: boolean;
    readonly type: 'Preimage';
  }

  /** @name PalletContractsHoldReason (305) */
  ...
  /** @name FrameSupportTokensMiscIdAmountRuntimeFreezeReason (308) */
  interface FrameSupportTokensMiscIdAmountRuntimeFreezeReason extends Struct {
    readonly id: CordWeaveRuntimeRuntimeFreezeReason;
    readonly amount: u128;
  }

  /** @name CordWeaveRuntimeRuntimeFreezeReason (309) */
  type CordWeaveRuntimeRuntimeFreezeReason = Null;

  /** @name PalletBalancesError (311) */
  ...
  /** @name PalletTreasuryProposal (320) */
  ...
  /** @name PalletTreasurySpendStatus (322) */
  ...
  /** @name PalletTreasuryPaymentState (323) */
  ...
  /** @name FrameSupportPalletId (324) */
  interface FrameSupportPalletId extends U8aFixed {}

  /** @name PalletTreasuryError (325) */
  ...
  /** @name PalletCollectiveVotes (328) */
  ...
  /** @name PalletCollectiveError (329) */
  ...
  /** @name PalletMembershipError (331) */
  ...
  /** @name PalletIdentityAuthorityProperties (358) */
  ...
  /** @name PalletSchedulerRetryConfig (368) */
  ...
  /** @name PalletPreimageOldRequestStatus (370) */
  ...
  /** @name PalletNodeAuthorizationNodeInfo (385) */
  interface PalletNodeAuthorizationNodeInfo extends Struct {
    readonly id: Bytes;
    readonly owner: AccountId32;
  }

  /** @name PalletNodeAuthorizationError (387) */
  ...
  /** @name PalletAssetsAssetAccount (390) */
  ...
  /** @name PalletAssetsAccountStatus (391) */
  ...
  /** @name PalletContractsWasmCodeInfo (400) */
  ...
  /** @name PalletContractsStorageDeletionQueueManager (406) */
  ...
  /** @name PalletContractsEnvironment (412) */
  ...
  /** @name PalletContractsEnvironmentTypeAccountId32 (413) */
  type PalletContractsEnvironmentTypeAccountId32 = Null;

  /** @name PalletContractsEnvironmentTypeU128 (414) */
  type PalletContractsEnvironmentTypeU128 = Null;

  /** @name PalletContractsEnvironmentTypeH256 (415) */
  type PalletContractsEnvironmentTypeH256 = Null;

  /** @name PalletContractsEnvironmentTypeBlakeTwo256 (416) */
  type PalletContractsEnvironmentTypeBlakeTwo256 = Null;

  /** @name PalletContractsEnvironmentTypeU64 (417) */
  type PalletContractsEnvironmentTypeU64 = Null;

  /** @name PalletContractsEnvironmentTypeU32 (418) */
  ...
  /** @name CordIdentifierIdentifierTypeOf (422) */
  ...
  /** @name CordIdentifierEventEntry (424) */
  ...
  /** @name CordIdentifierCallTypeOf (425) */
  ...
  /** @name CordIdentifierTimepoint (426) */
  interface CordIdentifierTimepoint extends Struct {
    readonly height: u32;
    readonly index: u32;
  }

  /** @name CordIdentifierError (428) */
  ...
  /** @name PalletNetworkMembershipMemberData (429) */
  interface PalletNetworkMembershipMemberData extends Struct {
    readonly expireOn: u32;
  }

  /** @name PalletNetworkMembershipError (431) */
  ...
  /** @name PalletSchemaSchemaEntry (444) */
  ...
  /** @name PalletChainSpaceSpaceDetails (446) */
  ...
  /** @name PalletChainSpaceSpaceAuthorization (447) */
  ...
  /** @name PalletChainSpacePermissions (448) */
  interface PalletChainSpacePermissions extends Struct {
    readonly bits: u32;
  }

  /** @name PalletChainSpaceError (450) */
  ...
  /** @name PalletStatementStatementDetails (451) */
  ...
  /** @name PalletStatementStatementPresentationDetails (453) */
  ...
  /** @name PalletNetworkScoreRatingEntry (459) */
  ...
  /** @name PalletNetworkScoreEntryTypeOf (460) */
  ...
  /** @name PalletNetworkScoreAggregatedEntryOf (462) */
  interface PalletNetworkScoreAggregatedEntryOf extends Struct {
    readonly countOfTxn: u64;
    readonly totalEncodedRating: u64;
  }

  /** @name PalletNetworkScoreError (464) */
  ...
  /** @name PalletAssetConversionPoolInfo (465) */
  interface PalletAssetConversionPoolInfo extends Struct {
    readonly lpToken: u32;
  }

  /** @name PalletAssetConversionError (466) */
  ...
  /** @name PalletRegistriesRegistryDetails (468) */
  ...
  /** @name PalletRegistriesRegistryAuthorization (469) */
  ...
  /** @name PalletRegistriesPermissions (470) */
  interface PalletRegistriesPermissions extends Struct {
    readonly bits: u32;
  }

  /** @name PalletRegistriesError (472) */
  ...
  /** @name PalletEntriesRegistryEntryDetails (473) */
  ...
  /** @name PalletSchemaAccountsSchemaEntry (475) */
  ...
  /** @name PalletSchemaAccountsError (476) */
  ...
  /** @name PalletNamespaceNameSpaceDetails (477) */
  ...
  /** @name PalletNamespaceNameSpaceAuthorization (481) */
  ...
  /** @name PalletNamespacePermissions (482) */
  interface PalletNamespacePermissions extends Struct {
    readonly bits: u32;
  }

  /** @name PalletNamespaceError (484) */
